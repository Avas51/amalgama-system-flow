...
const amalgamaBlocks = [
  ...
  },
  {
    ...
    text: 'Мой тыл надежен, мой дом — полная чаша. Гармония наполняет мою жизнь и дарит покой и стабильность. Я принимаю любовь и тепло с легкостью и благодарностью. Моё тело наполняется здоровьем, мой локоть восстанавливается, моя жизненная энергия растёт день ото дня.',
