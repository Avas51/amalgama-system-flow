...
const amalgamaBlocks = [
  {
    ...
    text: 'Я живу в согласии с собой и моим миром. Мой мощный потенциал плавно раскрывается, превращаясь в поток чистой созидательной силы. Я выбираю благополучие как свой естественный и гармоничный путь. Мой мир обеспечивает мой абсолютный комфорт и стабильность.',
    explanation: 'Этот блок устраняет внутренние конфликты. Мы признаем наличие огромной энергии (мощного потенциала) и даем ей команду на гармоничное раскрытие. Фраза «мой мир» утверждает вашу субъектность.',
  ...
  },
  {
    ...
    text: 'Я — экстраординарная личность, создающая свою судьбу. Я позволяю себе иметь всё, что пожелаю, по праву моего намерения. Моя уверенность — это моё спокойное и естественное состояние. Я достоин успеха, богатства и признания здесь и сейчас.',
