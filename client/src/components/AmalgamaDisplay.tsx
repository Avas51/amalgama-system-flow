...
const amalgamaBlocks = [
  {
    ...
    text: 'Я забочусь о моем мире, а мой мир заботится обо мне. Мой сжатый потенциал плавно раскрывается, превращаясь в поток чистой созидательной энергии. Я выбираю благополучие как мой естественный и гармоничный путь. Мой мир обеспечивает мне абсолютный комфорт и надёжность.',
  ...
  },
  {
    ...
    text: 'Я — востребованный специалист и успешный инженер-инноватор. Денежный поток течёт ко мне легко и непрерывно, обеспечивая процветание моей семьи. Мой мир крутится вокруг меня, предоставляя лучшие возможности для моих изобретений и проектов.',
  ...
  },
  {
    ...
    text: 'Мой тыл надежен, мой дом — полная чаша. Гармония наполняет мою жизнь и мой дом. Я принимаю любовь и тепло с легкостью и благодарностью. Моё тело наполняется здоровьем, мой локоть восстанавливается, моя жизненная энергия растёт день ото дня.',
